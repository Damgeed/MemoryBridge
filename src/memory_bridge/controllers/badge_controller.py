...
SVG_BADGE = '''<svg xmlns="http://www.w3.org/2000/svg" width="220" height="28">
  <defs>
  ...
  <rect width="220" height="28" rx="4" fill="url(#mb-bg)"/>
  <circle cx="14" cy="14" r="6" fill="white" opacity="0.9"/>
  <circle cx="14" cy="14" r="3" fill="#1f6feb"/>
  <text x="28" y="18" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-size="13" fill="white" font-weight="600">Memory Bridge</text>
</svg>'''
