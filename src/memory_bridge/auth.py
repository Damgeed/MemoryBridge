...
EXEMPT_PATHS = {"/", "/health", "/docs", "/openapi.json", "/redoc", "/playground", "/badge", "/graph", "/billing/webhook", "/pricing", "/dashboard", "/dashboard/", "/dashboard/recover", "/dashboard/free-signup", "/auth/register", "/auth/login", "/auth/my-key", "/auth/my-key-value", "/auth/oauth", "/auth/auth0/login", "/auth/auth0/callback", "/demo", "/api-docs"}
