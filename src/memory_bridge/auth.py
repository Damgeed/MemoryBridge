...
EXEMPT_PATHS = {"/", "/health", "/docs", "/openapi.json", "/redoc", "/playground", "/badge", "/graph", "/billing/webhook", "/billing/checkout", "/pricing", "/dashboard", "/dashboard/", "/dashboard/welcome", "/dashboard/recover", "/demo", "/api-docs"}
