...
EXEMPT_PATHS = {"/", "/health", "/docs", "/openapi.json", "/redoc", "/playground", "/badge", "/graph", "/billing/webhook", "/billing/checkout", "/pricing", "/dashboard", "/dashboard/", "/dashboard/welcome", "/demo", "/api-docs"}
