...
EXEMPT_PATHS = {"/", "/health", "/docs", "/openapi.json", "/redoc", "/playground", "/badge", "/graph", "/graph/data", "/billing/webhook", "/pricing", "/concept", "/concept/", "/dashboard", "/dashboard/", "/dashboard/recover", "/dashboard/free-signup", "/dashboard/stripe-welcome", "/auth/register", "/auth/login", "/auth/oauth", "/auth/auth0/login", "/auth/auth0/callback", "/auth/auth0/passwordless/start", "/auth/auth0/passwordless/start-sms", "/auth/auth0/passwordless/verify", "/demo", "/forgetful-demo", "/watch-demo", "/integrations", "/integration/langchain", "/integration/crewai", "/integration/autogen", "/integration/openai-agents", "/quickstart", "/api-docs", "/faq", "/CAPABILITIES.md"}
