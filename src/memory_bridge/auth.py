...
EXEMPT_PATHS = {"/", "/health", "/docs", "/openapi.json", "/redoc", "/playground", "/badge", "/graph", "/billing/webhook", "/billing/checkout", "/pricing", "/dashboard", "/dashboard/", "/dashboard/welcome", "/dashboard/recover", "/dashboard/free-signup", "/auth/register", "/auth/login", "/demo", "/api-docs"}
